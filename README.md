...
## Files
- `Regression_CLV_ML_Ivan.ipynb` : main project notebook
- `data_customer_lifetime_value.csv` : dataset used in this project
- `final_xgboost_clv_model.pkl` : saved final model
